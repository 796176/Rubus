...
public class Config {
	...
	public interface ConfigFunction<T, E extends Exception> {
		 ...
		 */
		T apply(@Nonnull Config c) throws E;
	}
	 ...
	 */
	public Config(@Nonnull Path configPath) throws IOException {
	 ...
	 */
	public synchronized void set(@Nonnull String key, @Nonnull String value) {
		params.put(key, value);
	}
	 ...
	 */
	public synchronized <T, E extends Exception> T action(@Nonnull ConfigFunction<T, E> a) throws E {
		return a.apply(this);
	}
	 ...
	 * @throws IOException if some I/O error occurs
	 */
	public synchronized void duplicate(@Nonnull Path dest) throws IOException {
		try (
	...
	private static class ImmutableConfig extends Config {
		...
		@Override
		public <T, E extends Exception> T action(@Nonnull ConfigFunction<T, E> a) throws E {
			return a.apply(this);
		}
		...
		@Override
		public void duplicate(@Nonnull Path dest) {
