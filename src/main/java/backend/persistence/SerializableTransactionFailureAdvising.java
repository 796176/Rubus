...
/**
 * An aspect to address serializable transaction failures in DAOs.<br>
 ...
 * TransactionLockFailureAdvising solves this by retrying failed transactions.<br><br>
 *
 ...
 */
@Aspect
public class SerializableTransactionFailureAdvising {

	private final Logger logger = LoggerFactory.getLogger(SerializableTransactionFailureAdvising.class);
	 ...
	 *                      retried
	 */
	public SerializableTransactionFailureAdvising(int retryAttempts) {
		setSerializableFailureRetryAttempts(retryAttempts);

		logger.debug("{} instantiated, retryAttempts: {}", this, retryAttempts);
	}

	/**
	 * An around type advice performed on any joint point of database access methods in {@link SqlAccessStrategy}.
	 ...
	 */
	@Around("this(backend.persistence.SqlAccessStrategy)")
	public Object transactionExecution(ProceedingJoinPoint jp) throws Throwable {
		logger.info("{} advising {}", this, jp.toLongString());
	 ...
	 */
	public int getSerializableFailureRetryAttempts() {
	 ...
	 */
	public void setSerializableFailureRetryAttempts(int retryAttempts) {
