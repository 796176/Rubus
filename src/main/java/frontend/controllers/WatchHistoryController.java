 ...
 */
public class WatchHistoryController implements WatchHistory {
	 ...
	 */
	public WatchHistoryController(Path watchHistoryPath) throws IOException {
	...
	public synchronized void setProgress(String mediaId, int progress) throws IOException {
		...
		// the progress value occupies 8 characters
